...
<head>
  ...
  <title><?php echo $title ?> | Hani Kosmetik</title>
...
<body class="hold-transition login-page">
  <div class="login-box">
    ...
    <div class="login-box-body">
      ...
      <center>
        <img src="<?= base_url() ?>assets/images/hani_logo.png" style="height:150px;max-width:300px;" alt="">
  ...
  <footer>
    <p class="text-center"><small>&copy; Copyright 2020 Hani Kosmetik</small></p>
  </footer>
